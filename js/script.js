...
const commands = {
	...
	{
		cmd: 'aboutme',
		res: 'About Me:<br># <span class="blue">Real Name:</span> Vladislav<br># <span class="blue">Born:</span> ' + sMonth["1"] + ' 02 2003 <span class="blue">(Age: ' + GetAge("2003-02-02") + ')</span><br># <span class="blue">Country:</span> Russia<br><br>Bio:<br># <span class="blue">Programming:</span> HTML,Python,Java,C++.<br># <span class="blue">Languages:</span><br>- Russian <span class="blue">(National)</span><br>- English <span class="blue">(Intermediate)</span>'
	},
	links: 
	{
		cmd: 'links',
		res: 'Links:<br># <span class="blue"><a href="https://discord.gg/uJyGxh" target="_blank"><u>Discord</u></a></span> - My Discord server.<br># <span class="blue"><a href="https://www.youtube.com/channel/UCjCTSX-UiWJ1RW_0NtoUW0w" target="_blank"><u>YouTube</u></a></span> - My YouTube channel.<br># <span class="blue"blue"><a href="https://vk.com/nissan_skynline" target="_blank"><u>VK</u></a></span> - You can find me there <span class="green">Online</span> most of the time. <br># <span class="blue"><a href="https://github.com/Subarochka1337" target="_blank"><u>Github</u></a></span> - Some trash code, I post there.'
	},
	visitors: 
	{
		cmd: 'visitors',
		...
		if (root > 0) {
			...
			if (vInput.startsWith("./")) {
				...
				if (vInput === "music play") {
					...
					var win = window.open("https://www.youtube.com/watch?v=TsNgNIySK74", "_blank");
					win.focus();
					launchCommandAsVisitor({
						cmd: vInput,
						res: ''
